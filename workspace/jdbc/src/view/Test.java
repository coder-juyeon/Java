...
//    아이디 중복 체크 and 회원가입
//      if (myUserDAO.checkId("lss12345")) {
//    	  System.out.println("사용 가능한 아이디입니다.");
//    	  myUserDAO.signUp(userVO);
//      }
//      else {
//    	  System.out.println("중복된 아이디입니다. /n 다른 아이디를 입력하세요.");
//      }
      
//      로그인
//      if(myUserDAO.signIn("lss1234", "1234")) {
...
//      아이디찾기
//      System.out.println("당신의 아이디: " + myUserDAO.findIdentification("01099998888"));
      
//      비밀번호 변경
//      myUserDAO.updateUserPassword("1111");
      
//     ------------------------------------막힘-------------------------------------
//      회원정보 조회
 
//      System.out.println(myUserDAO.select(userVO.getUserId()));
      
//      회원정보 수정
//      userVO.setUserNickname("거북왕");
//      myUserDAO.update(userVO);
